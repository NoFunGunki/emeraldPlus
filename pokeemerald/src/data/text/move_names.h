const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PARABOLIC_CHARGE] = _("ParablcChrge"),
    ...
    [MOVE_ELECTRIC_TERRAIN] = _("EltrcTerrain"),
    ...
    [MOVE_FIRST_IMPRESSION] = _("FrstImprsion"),
    [MOVE_BANEFUL_BUNKER] = _("BanefulBunkr"),
    [MOVE_SPIRIT_SHACKLE] = _("SpiritShckle"),
    [MOVE_DARKEST_LARIAT] = _("DrkestLariat"),
    [MOVE_SPARKLING_ARIA] = _("SprklngAria"),
    [MOVE_ICE_HAMMER] = _("Ice Hammer"),
    [MOVE_FLORAL_HEALING] = _("FlralHealing"),
