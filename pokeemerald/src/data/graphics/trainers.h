...
const u32 gTrainerFrontPic_Invis[] = INCBIN_U32("graphics/trainers/front_pics/invis_front_pic.4bpp.lz");
const u32 gTrainerPalette_Invis[] = INCBIN_U32("graphics/trainers/palettes/invis.gbapal.lz");
