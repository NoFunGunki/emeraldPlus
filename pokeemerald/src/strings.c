...
const u8 gText_Coffin[] = _("COFFIN");
const u8 gText_Creation[] = _("CREATION");
const u8 gText_Word[] = _("WORD");
const u8 gText_Zebra[] = _("ZEBRA");
const u8 gText_End[] = _("END");
const u8 gText_Beginning[] = _("BEGIN");
const u8 gText_GiveUp[] = _("I GIVE UP");
const u8 gText_Repeat[] = _("REPEAT RIDDLE?");
